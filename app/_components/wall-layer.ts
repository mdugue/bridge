 ...
 * the laser ground steps within ~0.75 m, the native DGM1 within ~1.7 m — and a
 * wall is not a CityJSON building, so it "goes missing". OSM has it as tagged lines with
