...
bun run bake --step canopy          # one step: landcover, canopy, trees,
                                    ...
                                    #   riverside, lowveg, islands (OSM squares into the class
...
| `landcover.py`, `canopy.py`, `trees.py`, `ndvi.py`, `roof_colour.py`, `lamps.py`, `monuments.py`, `furniture.py`, `walls.py`, `stairs.py`, `rail.py`, `surface.py`, `edges.py`, `sport.py`, `tram.py`, `riverside.py`, `lowveg.py` | one step each (table below) |
...
The OSM-derived files (`lamps`, `furniture`, `walls`, `stairs`, `bridge`, `platform`, `tram`, `riverside`, `lowveg`) carry
