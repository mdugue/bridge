...
bun run bake --step canopy          # one step: landcover, canopy, trees,
                                    ...
                                    #   riverside, names, lowveg, islands (OSM squares into the class
...
| `landcover.py`, `canopy.py`, `trees.py`, `ndvi.py`, `roof_colour.py`, `osm_buildings.py`, `lamps.py`, `monuments.py`, `furniture.py`, `walls.py`, `stairs.py`, `rail.py`, `surface.py`, `edges.py`, `sport.py`, `tram.py`, `riverside.py`, `names.py`, `lowveg.py` | one step each (table below) |
| `landcover.py`, `canopy.py`, `trees.py`, `ndvi.py`, `roof_colour.py`, `lamps.py`, `monuments.py`, `furniture.py`, `walls.py`, `stairs.py`, `rail.py`, `surface.py`, `edges.py`, `sport.py`, `tram.py`, `riverside.py`, `names.py`, `lowveg.py` | one step each (table below) |
| `lsc.py` | the laser scan → the 0.5 m rasters `lowveg` reads (laspy, PDAL's binning rules) |
...
last, thinned against the canopy and the cadastre.
...
when OSM trees were added), `canopyx` the GeoSN credit (laser scan), and `lowveg` both
