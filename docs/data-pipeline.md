...
[ADR 0032](./adr/0032-sites-providers-and-per-site-data.md)): **Python**
...
OSM extract ([ADR 0032](./adr/0032-sites-providers-and-per-site-data.md)).
...
| `landcover.py`, `landcover_osm.py`, `canopy.py`, `trees.py`, `ndvi.py`, `roof_colour.py`, `osm_buildings.py`, `rail.py`, `lamps.py`, `monuments.py`, `furniture.py`, `walls.py`, `stairs.py`, `surface.py`, `edges.py`, `markings.py`, `sport.py`, `tram.py`, `riverside.py`, `skyview.py`, `soundmarks.py`, `lowveg.py`, `cultivated.py`, `small_buildings.py` | one step each, in the order of the step table (`STEPS`; the table below) |
...
**Moving from the old layout** (`data/_raw/dresden/`, before ADR 0032):
