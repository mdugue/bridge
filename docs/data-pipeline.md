...
The OSM-derived files (`lamps`, `furniture`, `walls`, `stairs`, `bridge`, `platform`, `tram`, `riverside`, `names`, `lowveg`) carry
...
| street furniture GeoJSON | 0.01–0.03 MB (0.07–0.25 MB raw, with plan 030's signs and fixtures) |
...
| trams GeoJSON | 0.003–0.017 MB (0.01–0.09 MB raw) |
| riverside GeoJSON | ≤ 0.004 MB (≤ 0.02 MB raw) |
| street names GeoJSON | 0.009–0.017 MB (0.06–0.12 MB raw) |
