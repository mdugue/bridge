...
| **LSC** | Laserscan-Punktwolke | GeoSN | Heckenhöhen; Bäume in Höfen und Gärten; die Gartenlauben, Schuppen und Containerbauten, die dem 3D-Gebäudemodell fehlen |
...
| **Hier genutzt für** | Grundriss, Höhe, Dachform und Attribute jedes Gebäudes; die Grundrisse der Minikarte; das Abriss-Werkzeug. Die kleinen Bauten, die ihm fehlen, kommen aus dem Laserscan (siehe LSC). |
