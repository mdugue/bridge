...
| **Treppen** | Freitreppen wie die neben dem Italienischen Dörfchen, als einzelne Stufen | OpenStreetMap (`highway=steps`: Lage, Breite, Stufenzahl); Höhe von Fuß und Kopf aus dem Geländemodell | Echte Lage und Höhe; Stufenzahl eingetragen oder aus der Höhe geschätzt (16 cm je Stufe) |
