...
|---|---|---|---|
| **Gelände** | Die Form des Bodens: Flussufer, der Anstieg zur Neustadt, Dämme | Das amtliche Geländemodell mit 1 m Raster (**DGM1**) | Echte Höhen: ein Netz aus Dreiecken, das dem 1-m-Modell in deiner Nähe auf 15 cm folgt (weiter weg auf 50 cm), dicht, wo der Boden sich biegt. Senkrechte Mauern sind in der Quelle Rampen; wo OpenStreetMap eine Mauer kennt, stellt das Projekt sie auf die gemessene Stufe |
...
| **Bäume und Hecken** | Einzelbäume mit Kronen in gemessener Höhe; die Straßen- und Parkbäume der Stadt; Hecken und Baumreihen | Baumpositionen und -höhen aus der Differenz von Oberflächenmodell (**DOM1**) und Geländemodell; das **Stadtbaumkataster** der Landeshauptstadt Dresden (Standort, Höhe, Kronenbreite, Art); Bäume in Höfen aus dem **Laserscan**; Hecken aus **OpenStreetMap** in ihrer gelaserten Höhe; Reihen aus dem Basis-DLM; Grünfärbung aus dem Infrarot-Luftbild (**NDVI**) | Positionen und Höhen sind gemessen; Stadtbäume bekommen eine Kronenform nach ihrer Art (rund, säulenförmig, Nadelbaum, Trauerform …), die übrigen Kronen sind generisch |
