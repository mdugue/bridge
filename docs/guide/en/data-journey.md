...
| Street furniture | 16 kB | 5–17 kB | with the detailed terrain |
...
| New OpenStreetMap data | download a fresh Geofabrik extract and re-run the `lamps`, `furniture`, `monuments`, `walls`, `stairs`, `rail` and `tram` bakes | — |
