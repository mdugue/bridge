...
A stylised, walkable 3D model of the centre of Dresden: twelve tiles of
2 km × 2 km on both banks of the Elbe, 8 km × 6 km, with the historic
...
| **Buildings** | Every building with its real footprint, height and roof shape | The official 3D building model (**LoD2**), roughly 46,000 buildings and building parts in the twelve tiles | Real geometry. Facades are plain by design; there are no windows in the source data |
