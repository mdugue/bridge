...
| OSM via BBBike | Dresden extract | the extract of 2026-09-19 (fountains only: Geofabrik could not be reached from the build machine that day) | `data/dresden/provenance.json` | 2026-09-24 |
...
| OSM via BBBike (stairs) | the Dresden city extract | the extract of 2026-09-19 | the file's `Last-Modified`; `data/dresden/provenance.json` | 2026-09-24 |
| OSM via BBBike (paving) | the Dresden city extract | the extract of 2026-09-19 | the file's `Last-Modified`; `data/dresden/provenance.json` | 2026-09-25 |
...
the OSM credit inside the file as well; the monument file carries both
credits, because it combines the two.
