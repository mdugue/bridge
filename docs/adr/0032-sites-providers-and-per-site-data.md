# ADR 0032: Sites pick a provider; data per site, downloads per provider; fetch → bake → build
...
- [Plan 036](../plans/036-many-sites-one-env-var.md), [plan 017](../plans/017-germany-wide-sites.md),
