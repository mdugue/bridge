...
| 034 | Small structures from DOM − LoD2 (kiosks, sheds, carports), gated on a measurement | **DONE** (2026-09-26) — gate passed with a per-cell echo rule (213 on the spawn tile, 16 of 20 sampled are structures; the plan's blob-wide rule found 4); 6 783 on fifteen tiles, the Christmas markets excluded via OSM, +3.4 % city glTF; look unverified on a real GPU | [034-dom-minus-lod2.md](./034-dom-minus-lod2.md) |
