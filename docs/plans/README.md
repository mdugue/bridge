...
| 020 | WebGPURenderer + TSL instead of WebGL and `onBeforeCompile`; node post instead of `postprocessing`/`n8ao` | **IN PROGRESS** — Phase 0 spike done (look matches; WebGPU backend 2–3× slower in wide views); gate awaits the maintainer | [020-webgpu-tsl.md](./020-webgpu-tsl.md) |
