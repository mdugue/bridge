...
| 020 | WebGPURenderer + TSL instead of WebGL and `onBeforeCompile`; node post instead of `postprocessing`/`n8ao` | **TODO** — Phase 0 is a GPU spike; ADR 0027 proposed | [020-webgpu-tsl.md](./020-webgpu-tsl.md) |
